...
{
    public partial class FrmThemXeSuaDangKy : Form
    {
        ...
        public FrmThemXeSuaDangKy(string MaDVVC)
        {
            _MaDVVC = MaDVVC;
        ...
        private void FrmThemXeSuaDangKy_Load(object sender, EventArgs e)
        {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (result == DialogResult.OK)
                {
                    ...
                    FormEdelivery.FrmSuaMatHang.Instance.DK = Edelivery_GNHDAO.InsertThongTinTaiXe(txtBienSoXe.Text, txtRomoc.Text, txtCMND_GPLX.Text, txtHoten.Text, txtNoiCap.Text, dtNgaycap.Value);

                    FormEdelivery.FrmSuaMatHang.Instance.isInsertNew = true;
